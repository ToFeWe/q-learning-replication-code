...
def set_project_paths(ctx):
    ...
    pp = OrderedDict()
    pp["PROJECT_ROOT"] = "."
    pp["IN_SIMULATION_PARAMETER"] = "src/original_data/parameters"
    pp["IN_SIMULATION_GRID_3_AGENT"] = "src/original_data/simulation_data/3_agents/grid_search/"
    pp["IN_SIMULATION_GRID_2_AGENT"] = "src/original_data/simulation_data/2_agents/grid_search/"
    pp["IN_SIMULATION_SUPER_STARS_3_AGENT"] = "src/original_data/simulation_data/3_agents/super_stars/"
    pp["IN_SIMULATION_SUPER_STARS_2_AGENT"] = "src/original_data/simulation_data/2_agents/super_stars/"
    pp["IN_SIMULATION_3_AGENT"] = "src/original_data/simulation_data/3_agents/"
    pp["IN_SIMULATION_2_AGENT"] = "src/original_data/simulation_data/2_agents/"
